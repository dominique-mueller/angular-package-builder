...
| angular-package-builder | Angular            | TypeScript         | NodeJS     |
| ----------------------- | ------------------ | ------------------ | ---------- |
| `1.x.x`                 | `>= 5.0.0 < 5.1.0` | `>= 2.4.2 < 2.5.0` | `>= 7.6.0` |
| `1.x.x`                 | `>= 5.1.0 < 5.2.0` | `>= 2.4.2 < 2.6.0` | `>= 7.6.0` |
| `1.x.x`                 | `>= 5.2.0 < 6.0.0` | `>= 2.4.2 < 2.7.0` | `>= 7.6.0` |
