...
export class RollupConfigurationBuilder {
    ...
    constructor() {
        this.inputOptions = <RollupFileOptions>{
            ...
            plugins: [
                ...
                // Resolve packages the NodeJS / npm way (primarily based on the 'node_modules' folders)
                rollupNodeResolvePlugin(),

                // Handle CommonJS packages
                rollupCommonjsPlugin(),

                // Re-use sourcemaps generated by TypeScript
                rollupSourcemaps(),
    ...
    /**
     * Derive sourcemap file path ('fake' / non-existing path to fix sourcemap sources paths)
     *
     * @returns Sourcemap file path
     */
    private deriveSourcemapFilePath(): string {
        return path.join( path.dirname( this.inputOptions.input ), path.basename( this.outputOptions.file ) );
    }
