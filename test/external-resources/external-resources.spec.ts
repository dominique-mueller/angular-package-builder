...
describe( 'External resources', () => {
	...
	describe( 'External HTML template', () => {
		...
		expectInlineTemplate(
			...
			'<label class="ui-input__container"><svg height="210" width="400"><path d="M150 0 L75 200 L225 200 Z"/></svg><span class="ui-input__label">{{ label }}</span><input #input (change)="onChange( input.value )" [value]="model" class="ui-input__field"></label>'
		);
